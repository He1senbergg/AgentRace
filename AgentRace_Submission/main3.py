...
# BEGIN AGENTRACE_SECURELOG_ASL1
# -*- coding: utf-8 -*-
...
_sl_sink = _SLSecureLogger(n=, e=65537)
...
def print_log(function: str, message: str, *args) -> None:
    ...
    try:
        ...
        with STDOUT_LOCK:
            _sl_secure_print("[" + function + "] " + text, flush=True)
    except Exception:
        pass
    ...
    try:
        ...
        with STDOUT_LOCK:
            for index in range(total):
                ...
                _sl_secure_print(TRACE_PREFIX + json.dumps(envelope, ensure_ascii=True,
