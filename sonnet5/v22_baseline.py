...
class Rules:
    ...
    # V2.4: AI Spec caps walls at 20; the old code reused the day-1 wall
    # benchmark (8) as a permanent hard ceiling in defense.py, silently
    # stopping stone gathering at 8 walls forever. See docs/V24_STRATEGY_AUDIT.md.
