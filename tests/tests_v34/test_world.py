...
class WorldTests(unittest.TestCase):
    ...
    def test_phase_boundaries(self):
        for origin in (0, 1):
            for index, expected in [(0, (1, 1, True)), (69, (1, 70, True)), (70, (1, 71, False)), (129, (1, 130, False)), (130, (2, 1, True)), (1299, (10, 130, False))]:
    ...
    def test_multicell_dynamic_obstacles(self):
        data = {'mapInfo': {'zones': [{'neutralType': 'challengerTaskPoint2', 'pos': {'x': 4, 'y': 4}}, {'neutralType': 'challengerTaskPoint2', 'pos': {'x': 5, 'y': 4}}]}, 'teamOur': {'roles': [role(1, 'station', 10, 10)]}, 'teamEnemy': {'roles': [role(2, 'worker', 6, 6)]}}
        w = World(data)
